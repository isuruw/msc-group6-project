...
<div class="col-md-2 col-sm-1 hidden-xs display-table-cell valign-top"
	...
	<ul>
		...
		<!-- General - START -->
		<li
			class="link <%if ("commodity-categories".endsWith(url) || "containers".endsWith(url) || "ports".endsWith(url) || "ships".endsWith(url)) {%>active <%} else {%> null <%}%>">
			<a href="#collapse-general" data-toggle="collapse"
			aria-controls="collapse-general"> <span
				class="glyphicon glyphicon-th" aria-hidden="true"></span> <span
				class="hidden-sm hidden-xs">General</span>
		</a>
			<ul class="collapse collapseable" id="collapse-general">
				<li><a
					href="${pageContext.request.contextPath}/admin/general/commodity-categories">
					<span class="glyphicon glyphicon-equalizer" aria-hidden="true"></span>Comm. Categories<span
						class="label label-warning pull-right hidden-sm hidden-xs">21</span>
				</a></li>
				<li><a
					href="${pageContext.request.contextPath}/admin/general/containers">
					<span class="glyphicon glyphicon-hdd" aria-hidden="true"></span>Containers<span
						class="label label-warning pull-right hidden-sm hidden-xs">21</span>
				</a></li>					
				<li><a
					href="${pageContext.request.contextPath}/admin/general/ports">
					<span class="glyphicon glyphicon-tent" aria-hidden="true"></span>Ports<span
						class="label label-info pull-right hidden-sm hidden-xs">21</span>
				</a></li>
				<li><a
					href="${pageContext.request.contextPath}/admin//general/ships">
					<span class="glyphicon glyphicon-send" aria-hidden="true"></span>Ships<span
						class="label label-success pull-right hidden-sm hidden-xs">6</span>
				</a></li>
				<li><a
					href="${pageContext.request.contextPath}/admin//general/shippingCompanies">
					<span class="glyphicon glyphicon-bed" aria-hidden="true"></span>Shipping Companies<span
						class="label label-success pull-right hidden-sm hidden-xs">6</span>
				</a></li>
			</ul>
		</li>
