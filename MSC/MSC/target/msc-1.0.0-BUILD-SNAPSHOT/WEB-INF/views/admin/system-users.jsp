			...
			<div class="admin-content-con admin-content-con-primary">
				...
				<form:form role="form" method="post" action="addSystemUser"
					...
					<div class="box-body">
						...
						<div class="form-group">
							<div class="checkbox">
								<label><form:checkbox path="isActive" value="Make user active?"/>Make user active?
								</label>
							</div>
						</div>
					</div>
					...
					<tbody>
						...
						<c:forEach items="${systemUserList}" var="systemUser"
							...
							<tr>
								...
								<td>
									<button type="button" class="btn btn-xs btn-warning">edit</button>
									<a href="${pageContext.request.contextPath}/admin/users/removeSystemUser/${systemUser.id}">
										<button type="button" class="btn btn-xs btn-danger">delete</button>
									</a>
								</td>
							</tr>
