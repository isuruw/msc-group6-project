...
<div id="content">
	<header class="clearfix">
		<div class="row content-header-row">
			<h2 class="page_title pull-left">All un-approved comments</h2>
			<ol class="breadcrumb pull-right hidden-xs hidden-sm">
				...
				<li class="active">Un-approved Comments</li>
			</ol>
		</div>
	</header>
				...
				<div class="clearfix">
					<div class="pull-right">
						<a class="btn btn-xs btn-default" href="#" role="button">
							<sapn class="glyphicon glyphicon-thumbs-up" aria-hidden="true"></sapn>
							Approve
						</a>
						<a class="btn btn-xs btn-default" href="#" role="button">
